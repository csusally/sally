...
exports.createPages = ({ actions, graphql }) => {
  ...
  `).then(result => {
    ...
    const works = [
      { title: 'apple', img: '/assets/bg.png' ,link:'//www.baidu.com'},
      { title: 'helloork2', img: '/assets/bg/2.jpg', link: '//www.baidu.com' },
      { title: 'Welloork2', img: '/assets/bg/4.jpg', link: '//www.baidu.com' },
    ];
    createPage({
      path: `/workstest/`,
